...
# 侧边栏和菜单栏主题/字体/背景
Intellij IDEA - Preferences - Appearance & Behavior - Appearance - Theme & Use custom font & Background Image
# 编辑器主题/字体
Intellij IDEA - Preferences - Editor - Color Schema - Color Schema Font - Schema & Font
# 编辑器注释颜色
Intellij IDEA - Preferences - Editor - Color Schema - Language Defaults - Comments - Doc Comment - Text - Foreground - Hex=629755
# 显示行号和方法分隔符
...
Intellij IDEA - Preferences - Editor - Inspections - Java - Javadoc - Link specified as plain text & Blank line shuld be replaced with <p> to break lines - 取消勾选
...
# java错误: 无效的源发行版：17
pom.xml | File - Project Structure - Language level | Intellij IDEA - Settings - Java Compiler 三个地方的jdk版本要保持一致
