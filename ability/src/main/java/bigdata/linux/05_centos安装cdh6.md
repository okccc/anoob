...
<property>
    ...
    <value>org.apache.hive.ql.parse.authorization.HiveAuthorizationTaskFactoryImpl</value>
</property>
# 开启权限控制后无法直接操作hive
...
# return code 1 from org.apache.hive.ql.exec.mr.mapredlocaltask
...
# 主键冲突：duplicate entry '2017-09-18' for key 'primary'
...
# 不良: 此角色的事务日志目录所在的文件系统的可用空间小于5.0吉字节 /var/lib/zookeeper(可用4.8吉字节(23.84%),容量20.0吉字节)
原因：系统盘空间不足  
