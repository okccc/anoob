...
nohup /opt/com.okccc.spark/bin/com.okccc.spark-submit \
--class $class \
...
--conf com.okccc.spark.eventLog.enabled=true \
--conf com.okccc.spark.eventLog.dir=hdfs://jiliguala/sparklogs \
