...
object DauAPP {
  def main(args: Array[String]): Unit = {
    ...
    // ============================== 功能1.SparkStreaming消费kafka数据=============================
    // 1.从redis读取偏移量
    val offsetMap: Map[TopicPartition, Long] = MyOffsetUtil.getOffset(topicName, groupId)
    // 2.读取kafka数据
...
//    jsonDStream.print()  // {"mid":"11","hr":"18","dt":"2021-01-16","uid":"11","en":"start"...}
    ...
    // 1.遍历分区,涉及到数据库连接的操作,通常的是以分区为单位处理数据,减少数据库连接次数
